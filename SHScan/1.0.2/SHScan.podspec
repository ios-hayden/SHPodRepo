Pod::Spec.new do |s|
  ...
  s.source       = { :git => "ssh://gitolite@wccios.alpha.wochacha.com:65522/SHScan.git", :tag => "1.0.2" }

  s.source_files  = "SHScan/**/*.{h,m}"

  s.public_header_files = "SHScan/SHScanManager.h", "SHScan/SHScanResultHandleProtocol.h", "SHScan/SHScanResult.h"
